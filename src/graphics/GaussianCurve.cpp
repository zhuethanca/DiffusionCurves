...
//}
//
//void GaussianCurve::selectColor() {
//    if (selected != INFINITY) {
//        printf("Enter Color: ");
//        std::string s;
//        getline(std::cin, s);
...
//}
//
//void GaussianCurve::renderNormToMatrix(Eigen::SparseMatrix<double> &data, size_t width, size_t height) {
...
//}
//
//void GaussianCurve::flood_fill(Point start, Eigen::MatrixXi &map, Point corner, std::map<int, std::vector<double>> &out,
